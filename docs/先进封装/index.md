...
| 2️⃣ | **日月光（ASE）** 🥈 | OSAT（纯封测） | 全球封测 ~30% | 全球最大封测厂，传统+先进都有 |
| 3️⃣ | **安靠（Amkor）** 🥉 | OSAT | ~20% | 美系封测龙头 |
| 4️⃣ | **长电科技（JCET）** | OSAT | ~12%（全球第三） | 国内第一，收购星科金朋后全球第三 |
| 5️⃣ | **通富微电（TFME）** | OSAT | ~5-6% | 与 AMD 深度绑定 |
...
| 公司 | 定位 | 看点 |
|:-----|:------|:-----|
| **Amkor** 🥉 | 美系封测老二 | 苹果 SiP 封装主力，CoWoS 配套参与 |
| **通富微电** | AMD 封测伙伴 | 与 AMD 深度绑定，收入 ~70% 来自 AMD |
