...
| 公司 | 代码 | 说明 |
|:----|:----|:-----|
| **ASML（阿斯麦）** | **ASML**（美股） | 全球光刻机绝对龙头，垄断 EUV 市场，确定性高。PE ~35-40x，适合长期关注 |

> A 股所谓的「光刻机供应链」公司大多处于研发投入期，盈利不稳定，与 ASML 的实际业务关联度有限，不存在真正意义上的「光刻机概念核心标的」。
...
光刻机是芯片制造的核心，但不是唯一。芯片制造需要经过 **上千道工序**，主要设备包括：

### ① 🧪 刻蚀设备（Etch）

刻蚀把光刻好的电路图案"刻"到硅片上。光刻只是**画图案**，刻蚀才是**把图案变成立体的**。

| 是什么 | 为什么重要 | 🇨🇳 中国差距 |
|:------|:----------|:------------|
| 刻蚀机用等离子体"轰掉"不需要的材料，留下想要的电路结构。3nm 芯片需要 ~100+ 道刻蚀步骤。 | 刻蚀步骤数量随制程提升暴增——7nm 用 ~50 次，3nm 用 ~100+ 次。 | ✅ **差距最小！** 中微公司的刻蚀机已经打入台积电 5nm 供应链，全球市占率 ~15%。 |

### ② 🧪 薄膜沉积设备（Deposition）

在硅片上"铺"一层均匀的薄膜——可以是导电的（金属）、绝缘的（氧化物）或半导体的。

| 是什么 | 为什么重要 | 🇨🇳 中国差距 |
|:------|:----------|:------------|
| CVD/PVD/ALD 三种沉积技术，把原子一层层"堆"上去。芯片从上到下几十层结构，每一层都需要沉积。 | 3D NAND 堆叠层数从 64 层→400+ 层，沉积设备需求暴增。 | ⚠️ **差距 ~3-5 年。** 北方华创在 PVD/CVD 上已有突破，但高端 ALD 仍落后应用材料。 |

### ③ 🔍 检测设备（Inspection & Metrology）

在制造的每一步检查：这步有没有做对？芯片上有没有灰尘/缺陷？

| 是什么 | 为什么重要 | 🇨🇳 中国差距 |
|:------|:----------|:------------|
| 检测设备在芯片制造过程中持续扫描，发现纳米级缺陷。一颗 3nm 芯片有 ~200 亿晶体管，任何一处缺陷都会导致整片报废。 | 良率就是利润。检测设备越精密，良率越高，芯片厂越赚钱。 | ❌ **差距巨大。** 科磊（KLA）全球垄断 ~55%，国内中科飞测刚起步，产品线还不全。 |

### 三大设备赛道对比

| 设备类型 | 全球龙头 | 市值 | 中国对标 | 中国差距 | A股有吗 |
|:---------|:---------|:-----|:---------|:---------|:-------|
| **🧪 刻蚀** | Lam Research (LRCX) | ~$1,200 亿 | **中微公司** 🏆 | ✅ **差距最小** | ✅ 688012 |
| **🧪 薄膜沉积** | 应用材料 (AMAT) | **~$3,638 亿** | 北方华创 | ⚠️ 3-5年 | ✅ 002371 |
| **🔍 检测** | 科磊 (KLA) | ~$1,000 亿 | 中科飞测 | ❌ 巨大 | ✅ 688361 |

> 🔑 **核心结论**：所有半导体设备里，**中国差距最小、最值得关注的是刻蚀设备**（中微公司），因为刻蚀步骤数量随 AI 芯片需求暴增，中微已打进台积电 5nm 供应链。

👉 [查看中微公司分析](688012.md) · [北方华创分析](002371.md)
