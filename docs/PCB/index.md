...
![PCB 板实物图 — 绿色阻焊层 + 金色走线 + BGA 芯片 + 焊盘 + 金手指](../assets/images/pcb-board-real.jpg)
*上图：nano banana 生成的 PCB 电路板实拍照片。图中标注了阻焊层、铜箔走线、BGA 封装芯片、焊盘、金手指等关键部件。*
...
![PCB 多层板截面结构图 — 24层叠构、铜箔层、绝缘介质、各类导通孔](../assets/images/pcb-cross-section-real.jpg)
*上图：nano banana 生成的 PCB 多层板截面图。图中标注了 24 层叠构、阻焊层、铜箔走线、内层铜箔、绝缘介质层、通孔/盲孔/埋孔和锡球。AI 服务器 PCB 需要 20-30 层，而普通服务器只要 8-16 层。*

![AI 服务器内部结构 — GPU卡通过 PCIe 插槽连接到主板，背板负责高速互联](../assets/images/ai-server-internal-real.jpg)
*上图：nano banana 生成的 AI 服务器内部结构示意图（液冷版）。图中标注了 GPU 加速卡、GPU 芯片、液冷板（Cold Plate）、冷却液管路、CDM 分配器、主板、背板和 PCIe 插槽。现代 AI 服务器已全面采用液冷散热。*

> 💡 **看懂了这张图，你就知道为什么 AI 服务器需要这么多 PCB 和连接器了：** 每张 GPU 卡本身就是一块 PCB（子卡），一台 8 卡服务器除了 8 块子卡，还有主板 PCB 和背板 PCB，而且每张 GPU 卡都要通过 PCIe 插槽（一种连接器）插到主板上。光这一台机器里就涉及 10 块以上的 PCB 和近千个连接器。
...
| 梯队 | 公司 | 总部 | 核心优势 |
|:----:|:-----|:----|:---------|
| **🥇 第一梯队**<br/>技术最顶尖 | **AT&S** | 🇦🇹 奥地利 | AI服务器高端PCB全球第一，40层+量产，英伟达直接认证 |
| | **Ibiden** | 🇯🇵 日本 | 封装基板技术全球最顶尖，FC-BGA载板良率最高 |
| | **欣兴电子** | 🇹🇼 台湾 | IC载板营收+技术全球第一，英伟达核心供应商 |
| **🥈 第二梯队**<br/>技术先进，追赶中 | **沪电股份** | 🇨🇳 中国 | 国内AI PCB最领先，30层+量产能力，英伟达间接供应 |
| | **深南电路** | 🇨🇳 中国 | PCB+IC载板双驱动，FC-BGA载板国产替代刚起步 |
| | **三星电机** | 🇰🇷 韩国 | IC载板技术不错，但高端AI份额不如台/日 |
| | **TTM Technologies** | 🇺🇸 美国 | 军工级技术，AI服务器PCB非核心 |
| **🥉 第三梯队**<br/>规模大但技术不在最尖端 | **臻鼎/鹏鼎控股** | 🇹🇼 台湾 | 全球营收第一（~$50亿），但强在消费电子软板，AI占比<10% |
| | **旗胜/Nippon Mektron** | 🇯🇵 日本 | 全球软板龙头，AI硬板赛道不同 |
...
![AI 服务器中的各类连接器 — PCIe 插槽、高速背板连接器、IO 端口、FPC 排线](../assets/images/connector-types-real.jpg)
*上图：nano banana 生成的 AI 服务器各类连接器实拍照片。图中标注了 PCIe 插槽、高速背板连接器（公/母）、网口、FPC 排线连接器、电源连接器等。*
...
> **AI 芯片出货 → AI 服务器出货（每台PCB价值3-5倍于普通服务器）→ PCB需求增长**

**全球受益：** AT&S、欣兴电子、Ibiden（技术领先，吃高端利润）
